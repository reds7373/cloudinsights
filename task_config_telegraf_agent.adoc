...
----
    ...
    groups: []
----
==== Installing the Kubernetes kube-state-metrics server 
...
Use the following documentation to install the link:task_config_telegraf_kubernetes.html#objects-and-counters[kube-state-metrics server].

https://github.com/NetAppDocs/cloudinsights/blob/master/task_config_telegraf_kubernetes.adoc    
==== Uninstalling the Agent
