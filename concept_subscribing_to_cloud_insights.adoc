...
* *Subscribe* to Cloud Insights for on-going, uninterrupted access to your data through one of the following:
** link:https://www.netapp.com/us/forms/sales-inquiry/cloud-insights-sales-inquiries.aspx[NetApp Sales] direct 
** link:https://www.market.netapp.com/cloud-insights/product/cloud-insights NetApp eCommerce portal
** link:https://aws.amazon.com/marketplace/pp/B07HM8QQGY[AWS Marketplace].
...
=== Self-Subscribe with NetApp eCommerce portal
-----------------TBD---------------------------

=== Self-Subscribe with AWS Marketplace
