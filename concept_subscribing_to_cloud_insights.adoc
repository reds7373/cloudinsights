...
INFORMATION: Downgrading to Basic Edition will delete any non-NetApp data collectors in your environment. Any data associated with those data collectors will also be deleted. 
