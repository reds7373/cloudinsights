...
==== New Infrastructure Data Collector: HPE Nimble Storage

* link:task_dc_hpe_nimble.html[HPE Nimble Storage] has been added as an Infrastructure data collector.
