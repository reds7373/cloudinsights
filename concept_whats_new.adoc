...
* Infastructure data (storage, VM, Ec2, ports, etc.): 1 hour. If there is null data from a data collector for a period of 1 hour or more, Cloud Insights will show a gap in the charts. Otherwise, no gap will be shown.
...
The default aggregation time interval for "Last 1 Hour" is now 1 minute, to better accomodate handling of null data gaps.
