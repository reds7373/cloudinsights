...
* If your primary focus will be on infrastructure and application monitoring and optimization, then choose *Set up Monitor and Optimize*.
* If your primary concern is around ransomware and insider threat, choose *Set up Cloud Secure*.

image:Onboarding_ChooseYourAdventure.png[Choose Your Adventure]

Simply follow the instructions to set up your environment on whichever path you choose.
