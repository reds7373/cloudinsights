...
* If your primary focus will be on data, cost, usage statistics, etc., then choose *Set up Monitor and Optimize*.
* If your primary concern is around security, choose *Set up Cloud Secure*.
