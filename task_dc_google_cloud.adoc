...
= NetApp Google Compute and Storage data collector
...
This data collector supports inventory collection from Google Compute and Storage cloud platform configurations. 
